...
Here we use the [___patchwork___](https://patchwork.data-imaginist.com/), but note that [__cowplot__](https://cran.r-project.org/web/packages/cowplot/index.html) is also a popular alternative.
...
In the future, the [__ggtext__](https://github.com/wilkelab/ggtext) will make styling text with markdown and css like syntax relatively easy.
